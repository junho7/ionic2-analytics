...
export class QuotesListPage {
  ...
  constructor(public navParams:NavParams, private http: Http, private navController: NavController, platform: Platform, private googleAnalytics:GoogleAnalytics) {
